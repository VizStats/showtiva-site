...
export default function V2() {
  ...
  return (
    <main className={`${styles.container} ${isMinimized ? styles.lightBg : ""}`}>
      <div className={`${styles.zigzagContainer} ${isMinimized ? styles.zigzagVisible : ""}`}>
        {/* Same 5 vertical stripes for the stroke entrance */}
        {[0, 1, 2, 3, 4].map((index) => (
          <div
            key={index}
      ...
      {/* Decorative neon dividing border */}
      <div className={`${styles.neonDivider} ${isMinimized ? styles.dividerVisible : ""}`}></div>
